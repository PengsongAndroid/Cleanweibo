package com.peng.weibo.ui.loginwb;
 ...
 */
public class LoginWbActivity extends BaseActivity {
    ...
    class AuthListener implements WeiboAuthListener {
        ...
        public void onComplete(Bundle values) {
            ...
            if (mAccessToken.isSessionValid()) {
                ...
                AccessTokenKeeper.writeAccessToken(LoginWbActivity.this, mAccessToken);
                startActivity(new Intent(LoginWbActivity.this, MainActivity.class));
                finish();
//                Toast.makeText(LoginWbActivity.this, R.string.weibosdk_demo_toast_auth_success, Toast.LENGTH_SHORT).show();
            } else {
                ...
                Toast.makeText(LoginWbActivity.this, message, Toast.LENGTH_LONG).show();
            }
        }

        @Override
        public void onCancel() {
            Toast.makeText(LoginWbActivity.this, R.string.weibosdk_demo_toast_auth_canceled, Toast.LENGTH_LONG).show();
        }

        @Override
        public void onWeiboException(WeiboException e) {
            Toast.makeText(LoginWbActivity.this, "Auth exception : " + e.getMessage(), Toast.LENGTH_LONG).show();
        }
    }
...
//                .subscribe(subscriber);
    ...
    public int bindLayout() {
        return R.layout.login_wb_layout;
    }
