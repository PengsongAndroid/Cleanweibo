...
public class test {
	...
	public String toString() {
		return "test{" + "id=" + id + ", idstr='" + idstr + '\'' + ", screen_name='" + screen_name + '\'' + ", name='" + name + '\''
				...
				+ ", followers_count=" + followers_count + ", friends_count=" + friends_count + ", pagefriends_count=" + pagefriends_count
				+ ", statuses_count=" + statuses_count + ", favourites_count=" + favourites_count + ", created_at='" + created_at + '\''
				+ ", following=" + following + ", allow_all_act_msg=" + allow_all_act_msg + ", geo_enabled=" + geo_enabled + ", verified="
				+ verified + ", verified_type=" + verified_type + ", remark='" + remark + '\'' + ", status=" + status + ", ptype=" + ptype
				+ ", allow_all_comment=" + allow_all_comment + ", avatar_large='" + avatar_large + '\'' + ", avatar_hd='" + avatar_hd
				...
				+ ", verified_source_url='" + verified_source_url + '\'' + ", follow_me=" + follow_me + ", online_status=" + online_status
				+ ", bi_followers_count=" + bi_followers_count + ", lang='" + lang + '\'' + ", star=" + star + ", mbtype=" + mbtype
				+ ", mbrank=" + mbrank + ", block_word=" + block_word + ", block_app=" + block_app + ", credit_score=" + credit_score
				+ ", user_ability=" + user_ability + ", urank=" + urank + '}';
	}
