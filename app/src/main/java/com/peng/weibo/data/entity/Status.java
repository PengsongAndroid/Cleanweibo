...
public class Status implements Parcelable {
	...
	// Status.parse(jsonObject.optJSONObject("retweeted_status"));
	...
	// status.bmiddle_pic_urls.add(thumbnailUrl.replace("thumbnail",
	// "bmiddle"));
	...
	// }
	//
	// if (status.thumbnail_pic_urls != null && status.thumbnail_pic_urls.size()
	// == 1) {
